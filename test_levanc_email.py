#!/usr/bin/env python3
"""
Test script để test email sync với levanc@company.com
"""
import sys
import os
...
def test_levanc_email_sync():
    """Test email sync service với levanc@company.com"""

    print("🧪 Testing Email Sync Service với levanc@company.com...")

    # Tạo record test
    test_data = {
        'name_app': 'Test Levanc Email Sync',
        'conversation_id': f'levanc-test-{int(time.time())}',
        'input_text': 'Test message with levanc email for sync',

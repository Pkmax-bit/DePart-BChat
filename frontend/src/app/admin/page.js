...
f u n c t i o n   P a y r o l l M a n a g e m e n t ( )   { 
     c o n s t   [ p a y r o l l s ,   s e t P a y r o l l s ]   =   u s e S t a t e ( [ ] ) ; 
     c o n s t   [ e m p l o y e e s ,   s e t E m p l o y e e s ]   =   u s e S t a t e ( [ ] ) ; 
     c o n s t   [ l o a d i n g ,   s e t L o a d i n g ]   =   u s e S t a t e ( t r u e ) ; 
     c o n s t   [ s e l e c t e d E m p l o y e e ,   s e t S e l e c t e d E m p l o y e e ]   =   u s e S t a t e ( " " ) ; 
     c o n s t   [ s e l e c t e d M o n t h ,   s e t S e l e c t e d M o n t h ]   =   u s e S t a t e ( " " ) ; 
     c o n s t   [ s h o w C a l c u l a t e F o r m ,   s e t S h o w C a l c u l a t e F o r m ]   =   u s e S t a t e ( f a l s e ) ; 
     c o n s t   [ c a l c u l a t i n g P a y r o l l ,   s e t C a l c u l a t i n g P a y r o l l ]   =   u s e S t a t e ( f a l s e ) ; 
     c o n s t   [ e x p a n d e d P a y r o l l ,   s e t E x p a n d e d P a y r o l l ]   =   u s e S t a t e ( n u l l ) ; 
 
     u s e E f f e c t ( ( )   = >   { 
         f e t c h P a y r o l l s ( ) ; 
         f e t c h E m p l o y e e s ( ) ; 
     } ,   [ ] ) ; 
 
     c o n s t   f e t c h P a y r o l l s   =   a s y n c   ( )   = >   { 
         t r y   { 
             c o n s t   r e s p o n s e   =   a w a i t   f e t c h ( " h t t p : / / l o c a l h o s t : 8 0 0 1 / a p i / v 1 / p a y r o l l / p h i e u - l u o n g / " ) ; 
             i f   ( r e s p o n s e . o k )   { 
                 c o n s t   d a t a   =   a w a i t   r e s p o n s e . j s o n ( ) ; 
                 s e t P a y r o l l s ( d a t a ) ; 
             } 
         }   c a t c h   ( e r r o r )   { 
             c o n s o l e . e r r o r ( " E r r o r   f e t c h i n g   p a y r o l l s : " ,   e r r o r ) ; 
         }   f i n a l l y   { 
             s e t L o a d i n g ( f a l s e ) ; 
         } 
     } ; 
 
     c o n s t   f e t c h E m p l o y e e s   =   a s y n c   ( )   = >   { 
         t r y   { 
             c o n s t   r e s p o n s e   =   a w a i t   f e t c h ( " h t t p : / / l o c a l h o s t : 8 0 0 1 / a p i / v 1 / e m p l o y e e s / " ) ; 
             i f   ( r e s p o n s e . o k )   { 
                 c o n s t   d a t a   =   a w a i t   r e s p o n s e . j s o n ( ) ; 
                 s e t E m p l o y e e s ( d a t a ) ; 
             } 
         }   c a t c h   ( e r r o r )   { 
             c o n s o l e . e r r o r ( " E r r o r   f e t c h i n g   e m p l o y e e s : " ,   e r r o r ) ; 
         } 
     } ; 
 
     c o n s t   h a n d l e C a l c u l a t e P a y r o l l   =   a s y n c   ( e )   = >   { 
         e . p r e v e n t D e f a u l t ( ) ; 
         i f   ( ! s e l e c t e d E m p l o y e e   | |   ! s e l e c t e d M o n t h )   { 
             a l e r t ( " V u i   l � n g   c h �n   n h � n   v i � n   v �   k �  t � n h   l ��n g " ) ; 
             r e t u r n ; 
         } 
 
         s e t C a l c u l a t i n g P a y r o l l ( t r u e ) ; 
         t r y   { 
             c o n s t   r e s p o n s e   =   a w a i t   f e t c h ( " h t t p : / / l o c a l h o s t : 8 0 0 1 / a p i / v 1 / p a y r o l l / t i n h - l u o n g " ,   { 
                 m e t h o d :   " P O S T " , 
                 h e a d e r s :   { 
                     " C o n t e n t - T y p e " :   " a p p l i c a t i o n / j s o n " , 
                 } , 
                 b o d y :   J S O N . s t r i n g i f y ( { 
                     m a _ n v :   s e l e c t e d E m p l o y e e , 
                     k y _ t i n h _ l u o n g :   s e l e c t e d M o n t h 
                 } ) 
             } ) ; 
 
             i f   ( r e s p o n s e . o k )   { 
                 c o n s t   r e s u l t   =   a w a i t   r e s p o n s e . j s o n ( ) ; 
                 a l e r t ( " �   t � n h   l ��n g   t h � n h   c � n g ! " ) ; 
                 f e t c h P a y r o l l s ( ) ;   / /   R e f r e s h   t h e   l i s t 
                 s e t S h o w C a l c u l a t e F o r m ( f a l s e ) ; 
                 s e t S e l e c t e d E m p l o y e e ( " " ) ; 
                 s e t S e l e c t e d M o n t h ( " " ) ; 
             }   e l s e   { 
                 c o n s t   e r r o r   =   a w a i t   r e s p o n s e . j s o n ( ) ; 
                 a l e r t ( " L �i   k h i   t � n h   l ��n g :   "   +   ( e r r o r . d e t a i l   | |   " U n k n o w n   e r r o r " ) ) ; 
             } 
         }   c a t c h   ( e r r o r )   { 
             c o n s o l e . e r r o r ( " E r r o r   c a l c u l a t i n g   p a y r o l l : " ,   e r r o r ) ; 
             a l e r t ( " L �i   k �t   n �i   k h i   t � n h   l ��n g " ) ; 
         }   f i n a l l y   { 
             s e t C a l c u l a t i n g P a y r o l l ( f a l s e ) ; 
         } 
     } ; 
 
     c o n s t   t o g g l e P a y r o l l D e t a i l s   =   ( p a y r o l l I d )   = >   { 
         s e t E x p a n d e d P a y r o l l ( e x p a n d e d P a y r o l l   = = =   p a y r o l l I d   ?   n u l l   :   p a y r o l l I d ) ; 
     } ; 
 
     c o n s t   f o r m a t C u r r e n c y   =   ( a m o u n t )   = >   { 
         r e t u r n   n e w   I n t l . N u m b e r F o r m a t ( " v i - V N " ,   { 
             s t y l e :   " c u r r e n c y " , 
             c u r r e n c y :   " V N D " 
         } ) . f o r m a t ( a m o u n t ) ; 
     } ; 
 
     i f   ( l o a d i n g )   { 
         r e t u r n   < d i v   c l a s s N a m e = " p - 6 " > a n g   t �i   d a n h   s � c h   p h i �u   l ��n g . . . < / d i v > ; 
     } 
 
     r e t u r n   ( 
         < d i v   c l a s s N a m e = " p - 4   s m : p - 6 " > 
             < d i v   c l a s s N a m e = " f l e x   f l e x - c o l   s m : f l e x - r o w   j u s t i f y - b e t w e e n   i t e m s - s t a r t   s m : i t e m s - c e n t e r   m b - 4   g a p - 4 " > 
                 < h 2   c l a s s N a m e = " t e x t - x l   s m : t e x t - 2 x l   f o n t - b o l d " > Q u �n   l �   L ��n g < / h 2 > 
                 < b u t t o n 
                     o n C l i c k = { ( )   = >   s e t S h o w C a l c u l a t e F o r m ( t r u e ) } 
                     c l a s s N a m e = " b g - b l u e - 6 0 0   t e x t - w h i t e   p x - 3   s m : p x - 4   p y - 2   r o u n d e d   h o v e r : b g - b l u e - 7 0 0   t e x t - s m   s m : t e x t - b a s e " 
                 > 
                     T � n h   L ��n g 
                 < / b u t t o n > 
             < / d i v > 
 
             { s h o w C a l c u l a t e F o r m   & &   ( 
                 < d i v   c l a s s N a m e = " f i x e d   i n s e t - 0   b g - g r a y - 6 0 0   b g - o p a c i t y - 5 0   f l e x   i t e m s - c e n t e r   j u s t i f y - c e n t e r   z - 5 0   p - 4 " > 
                     < d i v   c l a s s N a m e = " b g - w h i t e   p - 4   s m : p - 6   r o u n d e d - l g   s h a d o w - x l   m a x - w - m d   w - f u l l " > 
                         < h 3   c l a s s N a m e = " t e x t - l g   s m : t e x t - x l   f o n t - s e m i b o l d   m b - 4 " > T � n h   L ��n g < / h 3 > 
                         < f o r m   o n S u b m i t = { h a n d l e C a l c u l a t e P a y r o l l } > 
...
                                 < / l a b e l > 
                                 < s e l e c t 
                                     v a l u e = { s e l e c t e d E m p l o y e e } 
                                     o n C h a n g e = { ( e )   = >   s e t S e l e c t e d E m p l o y e e ( e . t a r g e t . v a l u e ) } 
                                     c l a s s N a m e = " w - f u l l   b o r d e r   b o r d e r - g r a y - 3 0 0   r o u n d e d - m d   s h a d o w - s m   p - 2   t e x t - b l a c k " 
                                     r e q u i r e d 
                                 > 
                                     < o p t i o n   v a l u e = " " > C h �n   n h � n   v i � n . . . < / o p t i o n > 
                                     { e m p l o y e e s . m a p ( ( e m p l o y e e )   = >   ( 
                                         < o p t i o n   k e y = { e m p l o y e e . m a _ n v }   v a l u e = { e m p l o y e e . m a _ n v } > 
                                             { e m p l o y e e . h o _ t e n }   ( M � :   { e m p l o y e e . m a _ n v } ) 
                                         < / o p t i o n > 
                                     ) ) } 
                                 < / s e l e c t > 
                             < / d i v > 
                             < d i v   c l a s s N a m e = " m b - 4 " > 
                                 < l a b e l   c l a s s N a m e = " b l o c k   t e x t - s m   f o n t - m e d i u m   t e x t - g r a y - 7 0 0   m b - 2 " > 
                                     K �  t � n h   l ��n g   ( Y Y Y Y - M M ) 
                                 < / l a b e l > 
                                 < i n p u t 
                                     t y p e = " m o n t h " 
                                     v a l u e = { s e l e c t e d M o n t h } 
                                     o n C h a n g e = { ( e )   = >   s e t S e l e c t e d M o n t h ( e . t a r g e t . v a l u e ) } 
                                     c l a s s N a m e = " w - f u l l   b o r d e r   b o r d e r - g r a y - 3 0 0   r o u n d e d - m d   s h a d o w - s m   p - 2   t e x t - b l a c k " 
                                     r e q u i r e d 
                                 / > 
                             < / d i v > 
                             < d i v   c l a s s N a m e = " f l e x   j u s t i f y - e n d   s p a c e - x - 3 " > 
                                 < b u t t o n 
                                     t y p e = " b u t t o n " 
                                     o n C l i c k = { ( )   = >   { 
                                         s e t S h o w C a l c u l a t e F o r m ( f a l s e ) ; 
...
                                         s e t S e l e c t e d M o n t h ( " " ) ; 
                                     } } 
                                     c l a s s N a m e = " p x - 4   p y - 2   t e x t - g r a y - 6 0 0   b o r d e r   b o r d e r - g r a y - 3 0 0   r o u n d e d - m d   h o v e r : b g - g r a y - 5 0 " 
                                 > 
                                     H �y 
                                 < / b u t t o n > 
                                 < b u t t o n 
                                     t y p e = " s u b m i t " 
                                     d i s a b l e d = { c a l c u l a t i n g P a y r o l l } 
                                     c l a s s N a m e = " p x - 4   p y - 2   b g - b l u e - 6 0 0   t e x t - w h i t e   r o u n d e d - m d   h o v e r : b g - b l u e - 7 0 0   d i s a b l e d : o p a c i t y - 5 0 " 
                                 > 
                                     { c a l c u l a t i n g P a y r o l l   ?   " a n g   t � n h . . . "   :   " T � n h   L ��n g " } 
                                 < / b u t t o n > 
                             < / d i v > 
                         < / f o r m > 
                     < / d i v > 
...
             ) } 
 
             < d i v   c l a s s N a m e = " b g - w h i t e   r o u n d e d - l g   s h a d o w   o v e r f l o w - h i d d e n " > 
                 < d i v   c l a s s N a m e = " o v e r f l o w - x - a u t o " > 
                     < t a b l e   c l a s s N a m e = " m i n - w - f u l l   d i v i d e - y   d i v i d e - g r a y - 2 0 0 " > 
                         < t h e a d   c l a s s N a m e = " b g - g r a y - 5 0 " > 
                             < t r > 
                                 < t h   c l a s s N a m e = " p x - 3   s m : p x - 6   p y - 3   t e x t - l e f t   t e x t - x s   f o n t - m e d i u m   t e x t - g r a y - 7 0 0   u p p e r c a s e   t r a c k i n g - w i d e r " > 
                                     M �   N V 
                                 < / t h > 
                                 < t h   c l a s s N a m e = " p x - 3   s m : p x - 6   p y - 3   t e x t - l e f t   t e x t - x s   f o n t - m e d i u m   t e x t - g r a y - 7 0 0   u p p e r c a s e   t r a c k i n g - w i d e r " > 
                                     H �  t � n 
...
                             { p a y r o l l s . l e n g t h   = = =   0   ?   ( 
                                 < t r > 
                                     < t d   c o l S p a n = " 7 "   c l a s s N a m e = " p x - 6   p y - 8   t e x t - c e n t e r   t e x t - g r a y - 5 0 0 " > 
                                         C h �a   c �   p h i �u   l ��n g   n � o 
                                     < / t d > 
                                 < / t r > 
                             )   :   ( 
                                 p a y r o l l s . m a p ( ( p a y r o l l )   = >   ( 
                                     < R e a c t . F r a g m e n t   k e y = { p a y r o l l . i d } > 
                                         < t r   c l a s s N a m e = " h o v e r : b g - g r a y - 5 0 " > 
                                             < t d   c l a s s N a m e = " p x - 3   s m : p x - 6   p y - 4   w h i t e s p a c e - n o w r a p   t e x t - s m   t e x t - g r a y - 9 0 0 " > 
                                                 { p a y r o l l . m a _ n v } 
                                             < / t d > 
                                             < t d   c l a s s N a m e = " p x - 3   s m : p x - 6   p y - 4   w h i t e s p a c e - n o w r a p   t e x t - s m   t e x t - g r a y - 9 0 0 " > 
                                                 { p a y r o l l . h o _ t e n } 
                                             < / t d > 
                                             < t d   c l a s s N a m e = " p x - 3   s m : p x - 6   p y - 4   w h i t e s p a c e - n o w r a p   t e x t - s m   t e x t - g r a y - 9 0 0 " > 
                                                 { p a y r o l l . k y _ t i n h _ l u o n g } 
                                             < / t d > 
                                             < t d   c l a s s N a m e = " p x - 3   s m : p x - 6   p y - 4   w h i t e s p a c e - n o w r a p   t e x t - s m   t e x t - g r a y - 9 0 0 " > 
                                                 { f o r m a t C u r r e n c y ( p a y r o l l . t o n g _ t h u _ n h a p ) } 
                                             < / t d > 
                                             < t d   c l a s s N a m e = " p x - 3   s m : p x - 6   p y - 4   w h i t e s p a c e - n o w r a p   t e x t - s m   t e x t - g r a y - 9 0 0 " > 
                                                 { f o r m a t C u r r e n c y ( p a y r o l l . t o n g _ k h a u _ t r u ) } 
                                             < / t d > 
                                             < t d   c l a s s N a m e = " p x - 3   s m : p x - 6   p y - 4   w h i t e s p a c e - n o w r a p   t e x t - s m   f o n t - m e d i u m   t e x t - g r e e n - 6 0 0 " > 
                                                 { f o r m a t C u r r e n c y ( p a y r o l l . l u o n g _ t h u c _ n h a n ) } 
                                             < / t d > 
                                             < t d   c l a s s N a m e = " p x - 3   s m : p x - 6   p y - 4   w h i t e s p a c e - n o w r a p   t e x t - s m   f o n t - m e d i u m " > 
                                                 < b u t t o n 
                                                     o n C l i c k = { ( )   = >   t o g g l e P a y r o l l D e t a i l s ( p a y r o l l . i d ) } 
                                                     c l a s s N a m e = " t e x t - b l u e - 6 0 0   h o v e r : t e x t - b l u e - 8 0 0 " 
                                                 > 
                                                     { e x p a n d e d P a y r o l l   = = =   p a y r o l l . i d   ?   " �n "   :   " X e m " } 
                                                 < / b u t t o n > 
                                             < / t d > 
                                         < / t r > 
                                         { e x p a n d e d P a y r o l l   = = =   p a y r o l l . i d   & &   ( 
                                             < t r > 
                                                 < t d   c o l S p a n = " 7 "   c l a s s N a m e = " p x - 6   p y - 4   b g - g r a y - 5 0 " > 
                                                     < d i v   c l a s s N a m e = " g r i d   g r i d - c o l s - 1   m d : g r i d - c o l s - 2   g a p - 6 " > 
                                                         < d i v > 
                                                             < h 4   c l a s s N a m e = " f o n t - s e m i b o l d   t e x t - g r a y - 8 0 0   m b - 2 " > C h i   t i �t   t h u   n h �p < / h 4 > 
                                                             < d i v   c l a s s N a m e = " s p a c e - y - 1   t e x t - s m " > 
                                                                 < d i v   c l a s s N a m e = " f l e x   j u s t i f y - b e t w e e n " > 
                                                                     < s p a n > L ��n g   t h e o   n g � y   c � n g : < / s p a n > 
                                                                     < s p a n > { f o r m a t C u r r e n c y ( p a y r o l l . c h i _ t i e t _ t h u _ n h a p ? . l u o n g _ t h e o _ n g a y _ c o n g   | |   0 ) } < / s p a n > 
                                                                 < / d i v > 
                                                                 < d i v   c l a s s N a m e = " f l e x   j u s t i f y - b e t w e e n " > 
                                                                     < s p a n > L ��n g   t n g   c a : < / s p a n > 
                                                                     < s p a n > { f o r m a t C u r r e n c y ( p a y r o l l . c h i _ t i e t _ t h u _ n h a p ? . l u o n g _ t a n g _ c a   | |   0 ) } < / s p a n > 
                                                                 < / d i v > 
                                                                 < d i v   c l a s s N a m e = " f l e x   j u s t i f y - b e t w e e n   f o n t - s e m i b o l d   t e x t - b l u e - 6 0 0 " > 
                                                                     < s p a n > L ��n g   s �n   p h �m   ( b a o   g �m   h o a   h �n g ) : < / s p a n > 
                                                                     < s p a n > { f o r m a t C u r r e n c y ( p a y r o l l . c h i _ t i e t _ t h u _ n h a p ? . l u o n g _ s a n _ p h a m   | |   0 ) } < / s p a n > 
                                                                 < / d i v > 
                                                                 < d i v   c l a s s N a m e = " f l e x   j u s t i f y - b e t w e e n " > 
                                                                     < s p a n > P h �  c �p   k h � c : < / s p a n > 
                                                                     < s p a n > { f o r m a t C u r r e n c y ( p a y r o l l . c h i _ t i e t _ t h u _ n h a p ? . p h u _ c a p _ k h a c   | |   0 ) } < / s p a n > 
                                                                 < / d i v > 
                                                             < / d i v > 
                                                         < / d i v > 
                                                         < d i v > 
                                                             < h 4   c l a s s N a m e = " f o n t - s e m i b o l d   t e x t - g r a y - 8 0 0   m b - 2 " > C h i   t i �t   k h �u   t r �< / h 4 > 
                                                             < d i v   c l a s s N a m e = " s p a c e - y - 1   t e x t - s m " > 
                                                                 < d i v   c l a s s N a m e = " f l e x   j u s t i f y - b e t w e e n " > 
                                                                     < s p a n > B H X H   ( 8 % ) : < / s p a n > 
                                                                     < s p a n > { f o r m a t C u r r e n c y ( p a y r o l l . c h i _ t i e t _ k h a u _ t r u ? . b h x h   | |   0 ) } < / s p a n > 
                                                                 < / d i v > 
                                                                 < d i v   c l a s s N a m e = " f l e x   j u s t i f y - b e t w e e n " > 
                                                                     < s p a n > B H Y T   ( 1 . 5 % ) : < / s p a n > 
                                                                     < s p a n > { f o r m a t C u r r e n c y ( p a y r o l l . c h i _ t i e t _ k h a u _ t r u ? . b h y t   | |   0 ) } < / s p a n > 
                                                                 < / d i v > 
                                                                 < d i v   c l a s s N a m e = " f l e x   j u s t i f y - b e t w e e n " > 
                                                                     < s p a n > B H T N   ( 1 % ) : < / s p a n > 
                                                                     < s p a n > { f o r m a t C u r r e n c y ( p a y r o l l . c h i _ t i e t _ k h a u _ t r u ? . b h t n   | |   0 ) } < / s p a n > 
                                                                 < / d i v > 
                                                                 < d i v   c l a s s N a m e = " f l e x   j u s t i f y - b e t w e e n " > 
                                                                     < s p a n > T h u �  T N C N : < / s p a n > 
                                                                     < s p a n > { f o r m a t C u r r e n c y ( p a y r o l l . c h i _ t i e t _ k h a u _ t r u ? . t h u e _ t n c n   | |   0 ) } < / s p a n > 
                                                                 < / d i v > 
                                                             < / d i v > 
                                                         < / d i v > 
                                                     < / d i v > 
